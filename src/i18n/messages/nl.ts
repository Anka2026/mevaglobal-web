...
import { serviceDetailsExtraNl } from "./extras/serviceDetailsExtra.nl";
...
export const nl: Dictionary = {
  ...
  home: {
    ...
    serviceAreas: [
      ...
      },
      {
        ...
        description:
          "Diensten met focus op datatraceerbaarheid en programma-afstemming: EPD’s, levenscyclusanalyse, gerecyclede inhoud en productgebonden milieuclaims.",
      },
      {
    ...
    whyTitle: "Waarom Meva Global",
    whyItems: [
      {
        title: "Senior, gericht technisch leiderschap",
        description:
          "Onze opdrachten lopen onder senior technisch toezicht—heldere scope, gedisciplineerde methodiek en beoordelingslogica op basis van bewijs.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Beoordelingsstappen, bevindingen en besluitvorming worden vormgegeven met betrouwbare documentatie die externe toetsing kan doorstaan.",
      },
      {
    ...
    processSteps: [
      {
        ...
        description:
          "Wij vastleggen aanvraag, beoogd gebruik en context en beoordelen op hoofdlijnen geschiktheid en planning.",
      },
      {
        title: "Scopebepaling",
        description: "Grenzen, criteria, toepasselijke normen en het beoogde gebruik van de verklaring worden schriftelijk vastgelegd.",
      },
      {
        title: "Document- en databeoordeling",
        description: "Bewijspakketten, rekenstructuren, volledigheid en datasporen worden systematisch beoordeeld.",
      },
      {
        title: "Technische beoordeling",
        description: "Steekproeven, herberekeningen, methodologietoetsen en plausibiliteitscontroles op materiële aannames.",
      },
      {
        title: "Locatiebezoek of remote review",
        description: "Waar passend verdiepen walkthroughs, interviews en controlepunten het bewijs.",
      },
      {
        title: "Interne technische review",
        description: "Bevindingen, besluitlogica en woordkeuze doorlopen vóór afronding een onafhankelijke interne technische review.",
      },
      {
        title: "Afronding",
        description:
  ...
  pages: {
      ...
      sections: [
        ...
        },
        {
          ...
          bullets: [
            ...
            "Een kader dat organisaties helpt effectiever te reageren op verwachtingen van kopers, investeerders en andere stakeholders",
          ],
        },
        {
        ...
        },
        {
          ...
          bullets: [
            ...
            "Kwaliteitscontroles vóór afgifte, inclusief interne review",
          ],
        },
      ],
    },
    ...
    serviceDetails: {
      "iso-14064-1": {
        heroEyebrow: "Organisatorische inventarisverificatie",
        title: "ISO 14064-1 — Verificatie Van Organisatorische Broeikasgasgegevens",
        intro:
          "De geloofwaardigheid van een organisatorische broeikasgasinventaris steunt niet alleen op de gerapporteerde cijfers, maar op duidelijk afgebakende grenzen, consequente methodiek, traceerbare databronnen en passende emissiefactoren. Meva Global voert onafhankelijke, gestructureerde technische verificatie uit voor broeikasgasverklaringen conform ISO 14064-1. Door rapportagegrenzen, rekenlogica, datastromen en onderliggende bewijslast systematisch te beoordelen, versterkt deze dienst de betrouwbaarheid van informatie die naar toezichthouders, afnemers en andere externe partijen wordt gecommuniceerd.",
        covers: {
          title: "Dienstomvang",
          bullets: [
            "Organisatorische grenzen, operationele controlebenadering, consolidatie, rapportageperiode en inventarisomvang technisch beoordeeld",
            "Kwantificering van Scope 1 en 2 als kern; geselecteerde Scope 3-categorieën wanneer context en datastructuur dat rechtvaardigen",
            "Verder dan cijfers toetsen: methodologische samenhang en onderbouwde bewijsstructuur achter de verklaring",
          ],
        },
        forWho: {
          title: "Voor Wie",
          bullets: [
            "Organisaties die inventarissen publiceren in duurzaamheids-, financiële en regelgevingsrapportages",
            "Teams die koolstofprestatie geloofwaardig moeten uitleggen aan afnemers, investeerders en ketenpartners",
            "Bestuur dat datastandaardisatie en interne beheersing over meerdere sites of landen wil versterken",
          ],
        },
        typicalScope: {
          ...
          bullets: [
            ...
            "Niet alleen het totaal, maar hoe het tot stand komt en hoe stevig het onderbouwd kan worden",
          ],
        },
        whyMatters: {
          title: "Waarom Het Ertoe Doet",
          bullets: [
            "Organisatorische GHG-data stuurt duurzaamheidsrapportage en zware gesprekken met klanten, financiering en publiek—met stakeholder-risico",
            "Strakke verificatie vergroot vertrouwen in emissiecijfers en versterkt beheersingsontwerp",
            "Een duidelijkere basis voor verbeterplannen, basisjaar en rapportagevolwassenheid op langere termijn",
          ],
        },
        approach: {
          title: "De Meva-Aanpak",
          bullets: [
            "Bewijsgerichte technische review, traceerbare registraties en onafhankelijke besluitvorming—geen checklist",
            "Zichtbaar maken wat robuust is, waar verduidelijking nodig is en wat de betrouwbaarheid materieel vergroot",
            "Sterkere verklaring voor deze cyclus en een volwassener fundament voor broeikasgasbeheer daarna",
          ],
        },
        cta: {
          title: "",
      ...
      "iso-14064-2": {
        heroEyebrow: "Project-GBG verificatie",
        title: "ISO 14064-2 — Verificatie Van Broeikasgasprojecten",
        intro:
          "De geloofwaardigheid van projectgebonden broeikasgasverklaringen steunt niet alleen op gerapporteerde reductie- of verwijderingsvolumes, maar op een robuust basisscenario, heldere projectgrenzen, consistente kwantificering en een monitoringsregime dat traceerbaar bewijs kan leveren. Meva Global voert onafhankelijke, gestructureerde technische verificatie uit voor projectverklaringen conform ISO 14064-2. Projectlogica, monitoringopzet, rekenmethodiek en onderliggende registraties worden systematisch beoordeeld—zodat zowel betrouwbaarheid als verdedigbaarheid van de uitkomsten sterker worden.",
        covers: {
          title: "Dienstomvang",
          bullets: [
            "Projectgrenzen, basisscenario, reductie-/verwijderingslogica, kwantificeringsmethode, rapportageperiode en technische aannames",
            "Monitoringsplan, databronnen, rekenstructuur en stuurparameters als samenhangend geheel",
            "Niet enkel het resultaat toetsen, maar de technische onderbouwing en steun door traceerbaar bewijs scherp krijgen",
          ],
        },
        forWho: {
          title: "Voor Wie",
          bullets: [
            "Projecteigenaren en ontwikkelaars die zich voorbereiden op koolstofcreditprogramma’s of registers",
            "Teams die projectuitkomsten tegenover financiers, partners en externe reviewers moeten verdedigen",
            "Operaties die monitoringsdiscipline en rapportagevolwassenheid over opeenvolgende perioden willen versterken",
          ],
        },
        typicalScope: {
          title: "Focus van de beoordeling",
          bullets: [
            ...
            "Eindresultaat én de samenhang tussen productie, monitoring en onderbouwing",
          ],
        },
        whyMatters: {
          title: "Waarom Het Ertoe Doet",
          bullets: [
            "Projectverklaringen wegen steeds zwaarder voor programma’s, stakeholderrapportage, financiering en koolstofmarktvoorbereiding",
            "Strakke verificatie vergroot vertrouwen, maakt methodologische hiaten zichtbaar en beperkt besluitvormingsrisico",
            "Betere datakwaliteit, monitoringsdiscipline en volwassenheid over volgende perioden",
          ],
        },
        approach: {
          title: "De Meva-Aanpak",
          bullets: [
            ...
            "Niet alleen het cijfer—geschiktheid basisscenario, betrouwbaarheid monitoring, datastromen en kernaannames samen",
            "Sterkere huidige verklaring én robuustere data- en monitoringsstructuur voor wat volgt",
          ],
        },
        cta: {
          title: "",
      ...
      "iso-14067": {
        heroEyebrow: "Carbon op productniveau",
        title: "ISO 14067 — Product Carbon Footprint (PCF) Verificatie",
        intro:
          "Een productcarbon footprint is meer dan één uitkomstgetal: het gaat om hoe u functionele eenheid en grenzen kiest, allocatie beslist, activiteitsdata en aannames onderbouwt, emissiefactoren op de rekenketen afstemt en resultaten vertaalt naar klantgerichte communicatie. Meva Global voert onafhankelijke verificatie uit van PCF-werk conform ISO 14067 en beoordeelt model, bewijslijn en externe communicatie in samenhang—zodat uw productverhaal in inkoop- en ketendialogen stevig blijft staan.",
        covers: {
          title: "Dienstomvang",
          bullets: [
            "Functionele eenheid, systeemgrenzen, allocatieprincipes en expliciete uitsluitingen",
            "Activiteitsdata, achtergronddatasets, aannames en de opbouw van datakwaliteit",
            "Samenhang tussen rekenresultaten, tabellen, toelichtende tekst en voetnoten",
          ],
        },
        forWho: {
          title: "Voor Wie",
          bullets: [
            "Productie- en duurzaamheidsteams die leveranciersvragen en klantvragenlijsten beantwoorden",
            "Merken die één consistente PCF-logica over een portfolio willen hanteren",
            "Organisaties die commerciële, marketing- en technische documentatie op één productcarbonlijn brengen",
          ],
        },
        typicalScope: {
          title: "Focus van de beoordeling",
          bullets: [
            ...
            "Of publieke samenvattingen en tabellen trouw blijven aan de onderliggende aannames",
          ],
        },
        whyMatters: {
          title: "Waarom Het Ertoe Doet",
          bullets: [
            "Maakt de logica achter catalogus- en inkoopkeuzes beter uitlegbaar en verdedigbaar",
            "Verkleint grijze zones die tot verkeerde lezing of scherpe technische vragen leiden",
            "Versterkt de basis voor verdere milieuclaims en productgerichte rapportage",
          ],
        },
        approach: {
          title: "De Meva-Aanpak",
          bullets: [
            "We lezen de PCF als keten—grens, datalijn en bewijs—niet als losse onderdelen op een lijst",
            "We richten ons op traceerbaarheid en verhaallijn, niet alleen op het hoofdgetal in de tabel",
            "We verwoorden bevindingen beheerst, passend bij uw scope en beoogd gebruik",
          ],
        },
        cta: {
          title: "",
      ...
      "iso-14046": {
        ...
        covers: {
          title: "Dienstomvang",
          bullets: [
            "Omvang en systeemgrenzen van de water footprint in product-, proces- of organisatiecontext",
            "Technische beoordeling van databronnen, methodiek, aannames en rekenstructuur",
            "Beoordeling van disclosure-taal, resultaatopbouw en ondersteunend bewijs voor externe bruikbaarheid",
          ],
        },
        forWho: {
          title: "Voor wie",
          bullets: [
            "Producenten die water footprint-data betrouwbaarder aan externe stakeholders willen presenteren",
            "Teams die water-impactdata versterken voor klant-, investeerders- of technische dossierverwachtingen",
            "Organisaties die milieu-uitlatingen op product- of procesniveau willen aanscherpen",
          ],
        },
        typicalScope: {
          title: "Focus van de beoordeling",
          bullets: [
            ...
            "Beoordeling van resultatentabellen en externe disclosure-framing op methodologische consistentie",
          ],
        },
        whyMatters: {
          title: "Waarom het telt",
          bullets: [
            "Versterkt betrouwbaarheid en traceerbaarheid van water footprint-data",
            "Vermindert methodologische onzekerheid en disclosure-risico",
            "Legt een steviger basis voor milieuclaims, supply-chain-beoordeling en exportgerichte technische dossiers",
          ],
        },
        approach: {
          title: "De Meva-aanpak",
          bullets: [
            "Onafhankelijke technische verificatie die systeemgrenzen, datastructuur en ondersteunende registraties gezamenlijk adresseert",
            "Reviewdiscipline gericht op methodiek, datapad en disclosure-credibiliteit, voorbij de headline-resultaten",
            "Professionele structuur die bestaande water footprint-disclosures versterkt en toekomstige cycli voorbereidt",
          ],
        },
        cta: {
          title: "",
      ...
      "lca-review": {
        ...
        covers: {
          title: "Dienstomvang",
          bullets: [
            "Technische beoordeling van doel- en scopebepaling, functionele eenheid en systeemgrenzen",
            "Review van databronnen, modelleerkeuzes, allocatiebenadering en methodologische aannames",
            "Toetsing van resultaatopbouw, interpretatiesectie en disclosure-kader voor extern gebruik",
          ],
        },
        forWho: {
          title: "Voor wie",
          bullets: [
            "Organisaties die milieuverklaringen op een steviger methodologische basis willen neerzetten",
            "Teams die LCA gebruiken voor productvergelijkingen, technische dossiers of duurzaamheidscommunicatie",
            "Fabrikanten die LCA-kwaliteit willen verhogen voor EPD, productclaims of interne besluitvorming",
          ],
        },
        typicalScope: {
          title: "Technische Beoordelingsscope",
          bullets: [
            "Plausibiliteitsbeoordeling van doel-/scope-opzet, dataflow en modelleerlogica",
            "Steekproeven op kritieke datasets, aannames, allocatiebenadering en resultaatstructuur",
            "Technische controle op interpretatie, communicatietaal en risico’s bij extern gebruik",
          ],
        },
        whyMatters: {
          title: "Waarom dit belangrijk is",
          bullets: [
            "Versterkt betrouwbaarheid, consistentie en traceerbaarheid van LCA-resultaten",
            "Vermindert methodologische onzekerheid en disclosure-risico",
            "Legt een steviger basis voor EPD, milieuclaims en productgerichte duurzaamheidsverklaringen",
          ],
        },
        approach: {
          title: "De Meva-aanpak",
          bullets: [
            "Onafhankelijke technische beoordeling waarin methodiek, datastructuur en modelleerkeuzes samen worden bezien",
            "Reviewdiscipline gericht op scope, datapad en interpretatiekwaliteit—niet alleen op de hoofdresultaten",
            "Professionele structuur die bestaand LCA-werk versterkt en toekomstige milieurapportage voorbereidt",
          ],
        },
        cta: {
          title: "",
      ...
      "epd-verification": {
        ...
        covers: {
          ...
          bullets: [
            "Beoordeling van naleving van PCR- en programmaregels, gedeclareerde scope en rapportagekader",
            "Doorlichting van datasets, modelleerkeuzes, aannames en opbouw van ondersteunende documentatie",
            "Verificatiegerichte beoordeling van publicatie-kritische inhoud, methodologische consistentie en opbouw van de verklaring",
          ],
        },
        forWho: {
          title: "Voor wie",
          bullets: [
            "Fabrikanten die een EPD-publicatie voorbereiden en een betrouwbaarder technisch dossier willen neerzetten",
            "Organisaties die inspelen op groene inkoop, productmilieudata en verwachtingen van externe stakeholders",
            "Teams die methodologische consistentie en publicatiediscipline rond productmilieuduurzaamheid nastreven",
          ],
        },
        typicalScope: {
          title: "Focus van de beoordeling",
          bullets: [
            ...
            "Vóór publicatie: controle op technische consistentie, toelichtingstaal en bewijsdossier",
          ],
        },
        whyMatters: {
          title: "Waarom dit belangrijk is",
          bullets: [
            "Maakt EPD-documentatie betrouwbaarder voor publicatie en externe stakeholderreview",
            "Vermindert methodologische onzekerheid en het risico op inhoudelijke bezwaren van afnemers of stakeholders",
            "Legt een steviger basis voor updates, productvariaties en vervolgtrajecten rond milieurapportage",
          ],
        },
        approach: {
          title: "De Meva-aanpak",
          bullets: [
            "Onafhankelijke verificatie waarin programmaregels, data-architectuur en ondersteunend bewijs integraal worden bezien",
            "Een reviewdiscipline die verder gaat dan de resultatentabel: methodiek, traceerbaarheid en betrouwbaarheid van de verklaring",
            "Professionele structuur die bestaand EPD-werk versterkt en het publicatieproces beheersbaarder maakt",
          ],
        },
        cta: {
          title: "",
      ...
      "recycled-content-verification": {
        ...
        covers: {
          title: "Reikwijdte van de dienst",
          bullets: [
            "Beoordeling van de berekeningslogica voor het aandeel gerecyclede inhoud, systeemgrenzen en monitoringopzet",
            "Doorlichting van massabalansbenadering, leveranciersinput, materiaalstromen en ondersteunende registraties",
            "Verificatiegerichte toetsing van verklaringstaal, scopebepaling en het claimkader voor extern gebruik",
          ],
        },
        forWho: {
          title: "Voor wie",
        ...
        typicalScope: {
          ...
          bullets: [
            ...
            "Controles vóór externe communicatie op formulering van inhoudsclaims en op het bewijsdossier",
          ],
        },
        whyMatters: {
          title: "Waarom dit belangrijk is",
          bullets: [
            "Versterkt betrouwbaarheid en traceerbaarheid van claims over gerecyclede inhoud",
            "Vermindert risico op verkeerde uitleg, bezwaren en disclosure-problemen",
            "Legt een stevigere basis voor afnemerverwachtingen, duurzaamheidscommunicatie en productboodschappen",
          ],
        },
        approach: {
          title: "De Meva-aanpak",
      ...
      "bio-based-content-verification": {
        ...
        covers: {
          title: "Reikwijdte van de dienst",
          bullets: [
            "Beoordeling van hoe het percentage biobased inhoud wordt bepaald, inclusief systeemgrenzen en datastructuur",
            "Review van leveranciersverklaringen, ondersteunende documentatie, rekenaanpak en methodologische onderbouwing",
            "Verificatiegerichte toets van disclosure-taal, scope-definitie en het claimkader voor extern gebruik",
          ],
        },
        forWho: {
          title: "Voor wie",
        ...
        typicalScope: {
          ...
          bullets: [
            ...
            "Verificatiecontroles op disclosure-taal en bewijsbestanden voor extern gerichte claims over biobased inhoud",
          ],
        },
        whyMatters: {
          title: "Waarom dit belangrijk is",
          bullets: [
            "Versterkt de betrouwbaarheid en traceerbaarheid van claims over biobased inhoud",
            "Vermindert risico op verkeerde uitleg, weerlegging en disclosure-exposure",
            "Bouwt een steviger basis voor afnemerverwachtingen, duurzaamheidsclaims en productcommunicatie",
          ],
        },
        approach: {
          title: "De Meva-aanpak",
      ...
      "asi-readiness-review": {
        ...
        covers: {
          title: "Reikwijdte van de dienst",
          bullets: [
            "Beoordeling van ASI-gerelateerde criteria, de bestaande documentatiestructuur en de integriteit van het bewijs",
            "Koppeling van registraties op locatie-, centraal en supply-chain-niveau aan relevante verwachtingen",
            "Verificatiebeoordeling van claimtaal, scope-definitie en het kader voor extern gebruik",
          ],
        },
        forWho: {
          title: "Voor wie",
        ...
        typicalScope: {
          ...
          bullets: [
            ...
            "Technische controle van het voorbereidingsdossier op helderheid, consistentie en geschiktheid voor externe beoordeling",
          ],
        },
        whyMatters: {
          title: "Waarom dit belangrijk is",
          bullets: [
            "Versterkt de geloofwaardigheid van ASI-voorbereidingsdossiers en de gereedheid voor beoordeling",
            "Vermindert het risico op ontbrekend bewijs, gefragmenteerde registraties en criteria-verstoring",
            "Bouwt een steviger basis voor afnemerverwachtingen, duurzaamheidsclaims en communicatie over verantwoorde ketens",
          ],
        },
        approach: {
          title: "De Meva-aanpak",
          bullets: [
            "Onafhankelijke verificatiebeoordeling waarin criteria, bewijsstructuur en operationele registraties integraal worden bezien",
            "Beoordelingsdiscipline die niet alleen naar documentaanwezigheid kijkt, maar naar hoe documenten aan relevante ASI-verwachtingen worden gekoppeld",
            "Professionele structuur die de huidige gereedheid versterkt en bijdraagt aan vervolgbeoordelingen",
          ],
        },
        cta: {
          title: "",
      ...
      "fsc-pefc-eudr-readiness": {
        ...
        covers: {
          title: "Reikwijdte van de dienst",
          bullets: [
            "Beoordeling van ketenbeheerregistraties, due diligence-dossiers en de bestaande documentatiestructuur",
            "Review van leveranciersverklaringen, broninformatie, ondersteunende documenten en de traceerbaarheidsketen",
            "Verificatiegerichte toets van het disclosure-kader en het voorbereidingsdossier voor extern gebruik",
          ],
        },
        forWho: {
          title: "Voor wie",
        ...
        typicalScope: {
          ...
          bullets: [
            ...
            "Technische controle van het voorbereidingsdossier op helderheid, consistentie en bewijskracht voor externe beoordeling",
          ],
        },
        whyMatters: {
          title: "Waarom dit belangrijk is",
          bullets: [
            "Versterkt de geloofwaardigheid van voorbereidingsdossiers en de gereedheid voor externe beoordeling",
            "Vermindert het risico op tegenwerpingen door ontbrekende registraties, zwakke traceerbaarheid en claimrisico",
            "Bouwt een steviger basis voor afnemerverwachtingen, exportdossiers en supply-chain communicatie",
          ],
        },
        approach: {
          title: "De Meva-aanpak",
          bullets: [
            "Onafhankelijke verificatiebeoordeling waarin ketenbeheer, brondocumentatie en documentatielogica integraal worden bezien",
            "Beoordelingsdiscipline die niet alleen naar bestandsaanwezigheid kijkt, maar naar hoe dossiers aan relevante kaders worden gekoppeld",
            "Professionele structuur die de huidige gereedheid versterkt en bijdraagt aan vervolgbeoordelingen",
          ],
        },
        cta: {
      ...
      "gri-esrs-data-assurance": {
        ...
        covers: {
          title: "Reikwijdte van de dienst",
          bullets: [
            "Beoordeling van indicatordefinities, databronnen en rapportagestructuur binnen het GRI / ESRS-bereik",
            "Review van rekenlogica, ondersteunende datasets, controlepunten en het disclosure-kader",
            "Verificatiegerichte toets van duurzaamheidsdata die voor extern gebruik is bedoeld",
          ],
        },
        forWho: {
          title: "Voor wie",
          bullets: [
            "Organisaties die de betrouwbaarheid van onder GRI of ESRS gepubliceerde data willen versterken",
            "Teams die indicatorlogica en bewijsstructuur in duurzaamheidsrapporten willen aanscherpen",
            "Bedrijven die datakwaliteit, interne beheersing en rapportagevolwassenheid willen vergroten",
          ],
        },
        typicalScope: {
          title: "Focus van de beoordeling",
          bullets: [
            ...
            "Verificatiecontroles op disclosure-taal en bewijsbestanden voor extern gerichte duurzaamheidsdata",
          ],
        },
        whyMatters: {
          title: "Waarom dit belangrijk is",
          bullets: [
            "Versterkt de betrouwbaarheid en traceerbaarheid van GRI / ESRS-data",
            "Vermindert risico op verkeerde uitleg, datainconsistentie en disclosure-exposure",
            "Bouwt een verdedigbaarder rapportagekader voor investeerders, afnemers en stakeholders",
          ],
        },
        approach: {
          title: "De Meva-aanpak",
          bullets: [
            "Onafhankelijke verificatiebeoordeling waarin indicatorlogica, databronnen en ondersteunend bewijs integraal worden bezien",
            "Reviewdiscipline gericht niet alleen op het eindcijfer, maar op de data- en beheersingsstructuur erachter",
            "Professionele aanpak die de bestaande architectuur van duurzaamheidsdata versterkt",
          ],
        },
        cta: {
          title: "",
      ...
      "sustainability-kpi-evidence-review": {
        heroEyebrow: "Diensten",
        title: "Verificatie Van Sustainability KPI-bewijs",
        intro:
          "De betrouwbaarheid van sustainability-KPI’s hangt niet alleen af van gepubliceerde cijfers, maar ook van de helderheid van KPI-definities, de geschiktheid van databronnen, de consistentie van de rekenlogica, de toereikendheid van ondersteunend bewijs en de interne rapportagediscipline. Meva Global biedt een onafhankelijke en gestructureerde verificatiebeoordeling voor de data en het bewijs achter sustainability-KPI’s. Deze dienst creëert via een systematische beoordeling van KPI-definities, datastromen, brondocumenten en ondersteunende toelichtingen een betrouwbaarder en professioneler kader voor externe communicatie.",
        covers: {
          title: "Reikwijdte van de dienst",
          bullets: [
            "Beoordeling van KPI-definities, databronnen en rekenlogica",
            "Review van brondocumenten, datatrails, controlepunten en rapportagestructuur",
            "Verificatiegerichte toets van KPI-disclosures die voor extern gebruik zijn bedoeld",
          ],
        },
        forWho: {
          title: "Voor wie",
          bullets: [
            "Organisaties die sustainability-KPI’s geloofwaardiger aan externe stakeholders willen presenteren",
            "Teams die de koppeling tussen KPI-definities en brongegevens willen versterken",
            "Bedrijven die datadiscipline in managementrapporten, duurzaamheidscommunicatie en investeerdersrelaties willen verhogen",
          ],
        },
        typicalScope: {
          title: "Focus van de beoordeling",
          bullets: [
            ...
            "Verificatiecontroles op disclosure-taal en bewijsbestanden voor extern gerichte KPI-communicatie",
          ],
        },
        whyMatters: {
          title: "Waarom dit belangrijk is",
          bullets: [
            "Versterkt de betrouwbaarheid en verdedigbaarheid van KPI’s",
            "Vermindert datainconsistentie, verkeerde uitleg en disclosure-risico",
            "Bouwt een steviger basis voor management-, investeerders- en stakeholdercommunicatie",
          ],
        },
        approach: {
          title: "De Meva-aanpak",
          bullets: [
            "Onafhankelijke verificatiebeoordeling waarin KPI-definities, databronnen en ondersteunend bewijs integraal worden bezien",
            "Beoordelingsdiscipline gericht niet alleen op het eindcijfer, maar op de data- en trailstructuur erachter",
            "Professionele aanpak die de KPI-data-architectuur en rapportagevolwassenheid versterkt",
          ],
        },
        cta: {
          title: "",
      ...
      "limited-assurance-readiness": {
        ...
        covers: {
          title: "Reikwijdte van de dienst",
          bullets: [
            "Beoordeling van data-, beheersings- en bewijsstructuur vóór limited assurance",
            "Review van proceseigenaarschap, brongegevens, documentatiediscipline en rapportageflow",
            "Toets van gereedheid vóór verificatie en van het disclosure-kader",
          ],
        },
        forWho: {
          title: "Voor wie",
          bullets: [
            "Organisaties die limited assurance met sterkere, beter georganiseerde voorbereiding willen ingaan",
            "Teams die hiaten in data-, beheersings- en bewijsstructuren vooraf willen zien",
            "Duurzaamheids- en rapportageteams die interne voorbereiding vóór verificatie willen versterken",
          ],
        },
        typicalScope: {
          title: "Focus van de beoordeling",
          bullets: [
            ...
            "Technische controle van kritieke hiaten en verbetergebieden vóór de limited assurance-fase",
          ],
        },
        whyMatters: {
          title: "Waarom dit belangrijk is",
      ...
      "non-financial-data-control-review": {
        ...
        covers: {
          title: "Reikwijdte van de dienst",
          bullets: [
            "Beoordeling van gegevensdefinities, controlepunten en brongegevensstructuur voor niet-financiële indicatoren",
            "Review van steekproefaanpak, ondersteunende documentatie en disclosure-kader",
            "Toets van naar extern gebruik gerichte datacontroles vanuit verificatieperspectief",
          ],
        },
        forWho: {
          title: "Voor wie",
          bullets: [
            "Organisaties die niet-financiële gegevens betrouwbaarder willen beheren en uitleggen",
            "Rapportageteams die beheersingsmechanismen en datadiscipline willen versterken",
            "Bedrijven die consistentie in duurzaamheids-, ESG- of operationele datastructuren willen verhogen",
          ],
        },
        typicalScope: {
          title: "Focus van de beoordeling",
          bullets: [
            ...
            "Verificatietoetsen op disclosure-taal en beheersingsstructuur voor extern gerichte niet-financiële disclosures",
          ],
        },
        whyMatters: {
          title: "Waarom dit belangrijk is",
        ...
        approach: {
          title: "De Meva-aanpak",
          bullets: [
            "Onafhankelijke verificatiebeoordeling waarin definities, beheersingsmechanismen en ondersteunende registraties integraal worden bezien",
            "Beoordelingsdiscipline gericht niet alleen op de bekendgemaakte indicator, maar op de data- en beheersingsstructuur die dat resultaat ondersteunt",
            "Professionele aanpak die de niet-financiële data-architectuur van de organisatie versterkt",
          ],
        },
        cta: {
          title: "",
      ...
      "indoor-air-quality-voc-review": {
        ...
        covers: {
          title: "Reikwijdte van de dienst",
          bullets: [
            "Beoordeling van VOC-emissiedata, testscope, productdefinitie en conformiteit met de toepasselijke norm",
            "Review van laboratoriumrapporten, technische documentatie, monsterinformatie en ondersteunende registraties",
            "Toets van disclosure-taal, gebruiksbeperkingen en het claimkader richting externe stakeholders",
          ],
        },
        forWho: {
          title: "Voor wie",
        ...
        typicalScope: {
          ...
          bullets: [
            ...
            "Controles op disclosure-taal en technische consistentie voor extern gerichte VOC- en indoor air quality-claims",
          ],
        },
        whyMatters: {
          title: "Waarom dit belangrijk is",
          bullets: [
            "Versterkt de betrouwbaarheid van verklaringen over indoor air quality en VOC",
            "Vermindert risico op verkeerde uitleg, technische weerlegging en disclosure-exposure",
            "Bouwt een steviger basis voor exportdossiers, projectspecificaties en productcommunicatie",
          ],
        },
        approach: {
          title: "De Meva-aanpak",
          bullets: [
            "Onafhankelijke verificatiebeoordeling waarin technische testdata, documentatiestructuur en disclosure-taal samen worden bezien",
            "Een reviewdiscipline gericht niet alleen op het gerapporteerde resultaat, maar op de test- en bewijsstructuur erachter",
            "Een professionele structuur die bestaande verklaringen over binnenluchtkwaliteit versterkt en volgende technische claimcycli ondersteunt",
          ],
        },
        cta: {
          title: "",
      ...
      "cbam-verification-support": {
        ...
        covers: {
          title: "Dienstomvang",
          bullets: [
            "Rapportagegrenzen, product- en locatiecontext en de gehanteerde methodologische aanpak",
            "Leveranciersdata, activiteitsdata, emissiefactoren en de onderliggende registratiestructuur",
            "Verklaringstaal, data-spoor en de technische basis die voor extern gebruik is bedoeld",
          ],
        },
        forWho: {
          title: "Voor Wie",
          bullets: [
            "Exporteurs die CBAM-gerelateerde emissiedata geloofwaardiger willen presenteren",
            "Producenten die leveranciersinput en embedded emissions strakker beheersen",
            "Teams die data- en documentatiestructuur willen versterken vóór externe communicatie",
          ],
        },
        typicalScope: {
          title: "Focus van de beoordeling",
          bullets: [
            ...
            "Technische toetsen op geschiktheid van gerapporteerde uitkomsten voor extern gebruik en op disclosure-risico",
          ],
        },
        whyMatters: {
          title: "Waarom Het Ertoe Doet",
        ...
        approach: {
          title: "De Meva-Aanpak",
          bullets: [
            "Onafhankelijke technische verificatie waarin methodiek, data-architectuur en bewijsbestanden samen worden bezien",
            "Een reviewdiscipline gericht op herkomst van data, traceerbaarheid en verklaringbetrouwbaarheid—niet alleen op de hoofdcijfers",
            "Een professionele structuur die uw huidige CBAM-datapositie versterkt en u voorbereidt op volgende rapportagecycli",
          ],
        },
        cta: {
          title: "",
      ...
      "eu-ets-verification-review": {
        ...
        covers: {
          title: "Reikwijdte van de dienst",
          bullets: [
            "Beoordeling van EU ETS-gerelateerde emissiedata, installatiegrenzen en monitoringaanpak",
            "Review van activiteitendata, emissiefactoren, rekenlogica en ondersteunende registratiestructuur",
            "Verificatiegerichte beoordeling van voorbereidingsdossiers bestemd voor extern gebruik of formele beoordeling",
          ],
        },
        forWho: {
          title: "Voor wie",
          bullets: [
            "Installaties die EU ETS-emissiedata betrouwbaarder en strakker willen presenteren",
            "Duurzaamheids- en milieuteams die monitoringplan, datastromen en bewijsstructuur willen versterken",
            "Organisaties die de technische gereedheid vóór formele verificatie of toezicht willen verhogen",
          ],
        },
        typicalScope: {
          title: "Focus van de beoordeling",
          bullets: [
            ...
            "Technische controle van het emissiedossier op helderheid, consistentie en bewijskracht vóór externe beoordeling",
          ],
        },
        whyMatters: {
          title: "Waarom dit belangrijk is",
          bullets: [
            "Versterkt geloofwaardigheid en verdedigbaarheid van EU ETS-gerelateerde emissieverantwoording",
            "Vermindert risico’s door ontbrekende registraties, zwakke monitoringlogica en datainconsistentie",
            "Verhoogt gereedheid vóór verificatie en interne beheersingsvolwassenheid",
          ],
        },
        approach: {
          title: "De Meva-aanpak",
          bullets: [
            "Onafhankelijke verificatiebeoordeling waarin installatiedata, monitoringlogica en ondersteunende registraties integraal worden bezien",
            "Beoordelingsdiscipline gericht niet alleen op het emissiecijfer, maar op de data- en processtructuur erachter",
            "Professionele aanpak die uw emissiedata-architectuur versterkt en formele vervolgprocessen ondersteunt",
          ],
        },
        cta: {
          title: "",
      ...
      "f-gases-verification-review": {
        ...
        covers: {
          title: "Reikwijdte van de dienst",
          bullets: [
            "Beoordeling van F-gas-gerelateerde apparatuurregistraties, gasvolumes en rapportagestructuur",
            "Review van service-, onderhouds-, vul-, terugwin- en lekregistraties",
            "Verificatiegerichte beoordeling van voorbereidingsdossiers bestemd voor extern gebruik of formele beoordeling",
          ],
        },
        forWho: {
          title: "Voor wie",
          bullets: [
            "Organisaties die F-gasregistraties betrouwbaarder en strakker willen organiseren",
            "Technische teams die apparatuurinventaris, servicesporen en bewijsstructuur willen versterken",
            "Entiteiten die de gereedheid vóór formele controle of compliance willen verhogen",
          ],
        },
        typicalScope: {
          title: "Focus van de beoordeling",
          bullets: [
            ...
            "Technische controle van het dossier voor externe beoordeling op helderheid, consistentie en bewijskracht",
          ],
        },
        whyMatters: {
          title: "Waarom dit belangrijk is",
          bullets: [
            "Versterkt betrouwbaarheid en traceerbaarheid van F-gas-gerelateerde registraties",
            "Vermindert problemen door ontbrekende servicesporen, zwakke registratie-architectuur en verklaringsrisico",
            "Legt een ordelijker en verdedigbaarder databasis voor technische teams en compliance-workflows",
          ],
        },
        approach: {
          title: "De Meva-aanpak",
          bullets: [
            "Onafhankelijke verificatiebeoordeling waarin apparatuurregistraties, servicesporen en ondersteunende documenten integraal worden bezien",
            "Beoordelingsdiscipline gericht niet alleen op gerapporteerde hoeveelheden, maar op de technische en operationele sporen die die registraties ondersteunen",
            "Professionele aanpak die de bestaande F-gas-data-architectuur van uw organisatie versterkt",
          ],
        },
        cta: {
          title: "",
      ...
      "maritime-mrv-verification-review": {
        ...
        covers: {
          title: "Reikwijdte van de dienst",
          bullets: [
            "Beoordeling van Maritime MRV-gerelateerde emissies, brandstofverbruik en reisregistraties",
            "Review van monitoringaanpak, databronnen, ondersteunende documenten en disclosure-kader",
            "Verificatiegerichte beoordeling van voorbereidingsdossiers bestemd voor extern gebruik of formele beoordeling",
          ],
        },
        forWho: {
          title: "Voor wie",
          bullets: [
            "Reederijen en operators die Maritime MRV-data betrouwbaarder en strakker willen organiseren",
            "Technische teams die scheepsgebonden registraties, brandstofdata en monitoringlogica willen versterken",
            "Organisaties die de gereedheid vóór formele beoordeling of verificatie willen verhogen",
          ],
        },
        typicalScope: {
          title: "Focus van de beoordeling",
          bullets: [
            ...
            "Technische controle van het Maritime MRV-dossier op helderheid, consistentie en bewijskracht vóór externe beoordeling",
          ],
        },
        whyMatters: {
          title: "Waarom dit belangrijk is",
          bullets: [
            "Versterkt betrouwbaarheid en traceerbaarheid van Maritime MRV-gerelateerde data-architectuur",
            "Vermindert problemen door ontbrekende registraties, zwakke brandstofsporen en verklaringsrisico",
            "Verhoogt gereedheid vóór verificatie en datadiscipline",
          ],
        },
        approach: {
          title: "De Meva-aanpak",
          bullets: [
            "Onafhankelijke verificatiebeoordeling waarin scheepsgebonden registraties, brandstofdata en ondersteunende documenten integraal worden bezien",
            "Beoordelingsdiscipline gericht niet alleen op het eindgerapporteerde cijfer, maar op de data- en operationele sporen die dat ondersteunen",
            "Professionele aanpak die het huidige Maritime MRV-voorbereidingsniveau van uw organisatie versterkt",
          ],
        },
        cta: {
          title: "",
      ...
      "custom-verification": {
        ...
        covers: {
          title: "Wat dit dekt",
          bullets: [
            "Maatwerk scope-definitie, criteria en beoogd gebruik",
            "Op bewijs gebaseerde technische beoordeling en steekproeflogica",
            "Besluitpad en statementformat afgestemd op beoogd extern gebruik",
          ],
        },
        forWho: {
          title: "Voor wie",
        ...
        typicalScope: {
          ...
          bullets: [
            ...
            "Besluitadvies en uitgiftepad voor verklaring/certificaat",
          ],
        },
        whyMatters: {
          title: "Waarom dit belangrijk is",
        ...
        approach: {
          title: "Hoe Meva dit aanpakt",
          bullets: [
            "Gestructureerde governance voor maatwerkcriteria en besluiten",
            "Evidence-first review met traceerbare dossiers",
            "Heldere statementtaal afgestemd op scope en beperkingen",
          ],
        },
        cta: {
          title: "Definieer je maatwerkscope",
          body: "Deel je criteria, grenzen en beoogd gebruik. We stellen een onafhankelijk reviewmodel en planning voor.",
        },
      },
      "iso-14064-3-review-support": {
        ...
        covers: {
          title: "Reikwijdte Van De Dienst",
          bullets: [
            "Het doel, de scope en de toepasselijke criteria voor het verificatie- of validatieproces",
            "Bewijsstructuren, datasets, methodologische basis en grenzen van de beoordeling",
            "Technische degelijkheid van procesontwerp, documentatiediscipline en besluitvormingsstructuur",
          ],
        },
        forWho: {
          title: "Voor Wie",
        ...
        typicalScope: {
          ...
          bullets: [
            ...
            "Plausibiliteitstoets op bevindingen, besluitlogica en outputkader",
          ],
        },
        whyMatters: {
          title: "Waarom Dit Belangrijk Is",
        ...
        approach: {
          title: "De Meva-Aanpak",
          bullets: [
            "Onafhankelijke technische beoordeling die procesontwerp, criteria en bewijsstructuren samen adresseert",
            "Reviewdiscipline gericht niet alleen op uitkomsten, maar op hoe besluiten tot stand komen",
            "Professionele aanpak die verificatie- en validatiepraktijken sterker en beter traceerbaar maakt",
          ],
        },
        cta: {
          title: "",
      ...
      "net-zero-sbti-technical-review": {
        ...
        covers: {
          title: "Reikwijdte Van De Dienst",
          bullets: [
            "Technische beoordeling van transitietraject, doelarchitectuur, scopekeuze en reductielogica",
            "Review van databasis, methodologisch kader, aannames en ondersteunende dossierstructuur",
            "Toetsing van disclosure-taal, doelformulering en het geloofwaardigheidskader voor extern gebruik",
          ],
        },
        forWho: {
          title: "Voor Wie",
          bullets: [
            "Organisaties die net-zero-roadmaps op een steviger technische grondslag willen neerzetten",
            "Teams die SBTi-gerelateerde doelstructuren willen versterken vóór interne en externe communicatie",
            "Duurzaamheids-, finance- en operationele teams die transitieplannen, data-architectuur en reductielogica strakker willen regisseren",
          ],
        },
        typicalScope: {
          title: "Focus van de beoordeling",
          bullets: [
            ...
            "Technische controles op toelichtingstekst, doelopbouw en risico bij externe communicatie",
          ],
        },
        whyMatters: {
          title: "Waarom Dit Belangrijk Is",
        ...
        approach: {
          title: "De Meva-Aanpak",
          bullets: [
            "Onafhankelijke technische verificatie die transitietraject, datastructuur en ondersteunend bewijs samen adresseert",
            "Reviewdiscipline gericht niet alleen op de doelformulering, maar op de technische onderbouwing ervan",
            "Professionele structuur die bestaande net-zero- en SBTi-toelichtingen versterkt en organisaties voorbereidt op vervolgcycli",
          ],
        },
        cta: {
          title: "",
    ...
    cbam: {
      ...
      sections: [
        {
          title: "Betrouwbare data als drager van CBAM-credibiliteit",
          bullets: [
            "Verwachte disclosures worden gelezen tegen installatie- en procesregistraties die totalen onderbouwen—niet tegen cijfers op zich",
            "Broze traceerbaarheid, vage grenzen of ondoorzichtige datastromen ondermijnen vertrouwen in CBAM-materiaal",
            "Een vroeg afgestemde architectuur beperkt later herwerk, rapportagefrictie en weerleggingsrisico",
          ],
        },
        {
          title: "Veelvoorkomende rapportage- en bewijsgaten",
          bullets: [
            "Niet-afgestemde systeemgrenzen tussen sites, producten of perioden",
            "Toewijzingslogica, factoren en rekenlijnen die moeilijk te reconstrueren of te verdedigen zijn",
            "Magere leveranciersonderbouwing, zwakke brondocumentatie en onvoldoende bewijs voor materiële drivers",
          ],
        },
        {
          title: "Waar de review zich concentreert",
          bullets: [
            "Technische lezing van scope, productgeoriënteerde data-inrichting en installatiegebonden rekenaanpak",
            "Gerichte steekproeven op brongegevens, ondersteunende dossiers en kritieke inputs",
            "Consistentiecheck op het externe CBAM-pakket: helderheid, interne lijn en verdedigbaarheid",
          ],
        },
        {
          title: "Leveranciersdata en installatiegerichte diepgang",
          bullets: [
        ...
        },
        {
          ...
          bullets: [
            ...
            "Een professionele ruggengraat die vandaag stabiliteit geeft en latere verificatie- of updatecycli ondersteunt",
          ],
        },
      ],
      cta: {
    ...
    process: {
      ...
      steps: [
        {
          title: "Eerste Geschiktheidsbeoordeling",
          description:
            "Er wordt eerst een technische geschiktheidsbeoordeling uitgevoerd op basis van de scope van de aanvraag, de toepasselijke normen en de beoogde planning.",
        },
        {
          title: "Afbakening Van Scope En Criteria",
          description:
            "Systeemgrenzen, referentiecriteria, aannames, beoogd gebruik en verwachte output worden schriftelijk vastgelegd.",
        },
        {
          title: "Beoordeling Van Documenten En Bewijs",
          description:
            "Het bewijspakket wordt systematisch beoordeeld op volledigheid, consistentie, traceerbaarheid van gegevens en ondersteunende registraties.",
        },
        {
          title: "Technische Verificatietests",
          description:
            "Steekproeven, herberekeningen, kruiscontroles en plausibiliteitstoetsen worden toegepast op kritische bepalende factoren.",
        },
        {
          title: "Locatiebezoek En Gesprekken",
          description:
        ...
        {
          title: "Afgifte Van Verklaring Of Certificaat",
          description:
            "Afhankelijk van de toepasselijke scope wordt een verklaring, verificatieresultaat of certificaat met referentienummer afgegeven; waar relevant kunnen beperkte openbare registergegevens worden gepubliceerd.",
        },
      ],
      cta: {
        eyebrow: BRAND_POSITIONING_LINE.nl,
    ...
    statementSearch: {
      ...
      placeholders: {
        statementNumber: "Bijv. MG-VER-2026-001",
        companyName: "Bijv. Bedrijfsnaam",
      },
      labels: {
        status: "Status",
      ...
      noResults: "Geen records die aan de huidige filters voldoen. Pas uw zoekcriteria aan.",
      emptyState: {
        line1:
          "U kunt gepubliceerde registraties zoeken via een referentienummer of relevante verklaringgegevens.",
        line2:
          "Wanneer er geen openbare registratie beschikbaar is, kunt u rechtstreeks contact met ons opnemen voor meer informatie.",
      },
    },
    documents: {
      title: "Kennisbank",
    ...
    contact: {
      ...
      validation: {
        ...
        submitted: "Dank je wel. Je bericht is ontvangen. We nemen binnenkort contact met je op.",
      },
      contactForm: {
      ...
      contactPlaceholders: {
        name: "Bijv. Naam Achternaam",
        email: "Bijv. naam@bedrijf.com",
        phone: "Bijv. +31 6 xxxx xxxx",
        company: "Bijv. Juridische bedrijfsnaam",
      ...
      quotePlaceholders: {
        standard: "Bijv. ISO 14064-1, ISO 14067, CBAM",
        reportingYear: "Bijv. 2025",
        details: "Wat moet worden beoordeeld, tegen wanneer en voor welk publiek?",
        email: "Bijv. naam@bedrijf.com",
      },
      helper: {
        responseTime: "Gebruikelijke reactietijd: 1–2 werkdagen.",
  ...
  serviceDetail: {
    backToServices: "Terug naar services",
